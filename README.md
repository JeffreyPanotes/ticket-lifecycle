...
From the Tickets we will navigate to open tickets.Navigate to priority and also the SLA plan , take a glance at the comments and depending on the severity of the comments the user input ,possiblity you may want to reach out to the customer to actually gauge the issue .
